...
export default function UmrohReguler({ packages }: Props) {
    ...
    return (
        <div className="flex min-h-screen flex-col justify-between bg-slate-50 font-sans">
            ...
            <main className="flex-grow bg-slate-50 pt-32 pb-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="mt-2 text-sm text-slate-500">
                            Daftar pilihan jadwal keberangkatan umroh reguler
                            PT. Annamiroh Travelindo.
                        </p>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xs">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm whitespace-nowrap">
                                <thead className="bg-[#115e59] text-xs font-bold tracking-wider text-white uppercase">
                                    <tr>
                                ...
                                <tbody className="divide-y divide-slate-100 bg-white">
                                    {packages.length === 0 ? (
                                        <tr>
                                            ...
                                            >
                                                Belum ada paket reguler yang
                                                dijadwalkan saat ini.
                                            </td>
                                        </tr>
                                    ) : (
                                        packages.map((pkg) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-5">
                                                    <div className="flex flex-col gap-0.5">
                                                        ...
                                                        {pkg.airline_route && (
                                                            <span className="text-slate-405 pl-5 text-[11px] font-medium tracking-wide italic">
                                                                {
                                                                    pkg.airline_route
                                                                }
                                                            </span>
                                                ...
                                                <td className="px-6 py-5 text-center">
                                                    <Link
                                                        ...
                                                        className="inline-flex items-center justify-center rounded-lg bg-[#115e59] px-4 py-2 text-xs font-bold text-white shadow-xs transition-all hover:bg-[#0f514c] active:scale-95"
                                                    >
                                                        SELENGKAPNYA
                                                    </Link>
                                                </td>
