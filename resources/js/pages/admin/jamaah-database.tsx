...
export default function JamaahDatabase({
    jamaahs,
    totalJamaahCount,
    passportFilledCount,
    filters,
            ...
            <div className="mb-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
                <div>
                    <h1 className="flex items-center gap-2 text-2xl font-black tracking-tight text-slate-800">
                        ...
                        Database Jamaah (Master)
                    </h1>
                    <p className="mt-1 text-sm font-bold text-slate-500">
                        Daftar lengkap seluruh data jamaah yang terdaftar dalam
                        sistem untuk digunakan kembali saat booking order.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="w-64 rounded-xl border-slate-300 bg-white pl-9 font-bold text-slate-700 shadow-sm"
                        />
                    </div>
                    <Button
                        onClick={handleSearchSubmit}
                        className="rounded-xl bg-emerald-600 font-bold shadow-md hover:bg-emerald-700"
                    >
                        Cari
                    </Button>
                </div>
            ...
            <div className="mb-6 grid gap-6 md:grid-cols-2">
                ...
                <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div>
                        ...
                        <p className="mt-1 text-xs font-bold text-slate-400">
                            Jumlah seluruh profil jamaah terdaftar.
                        </p>
                    </div>
                ...
                <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div>
                        ...
                        <p className="mt-1 text-xs font-bold text-slate-400">
                            Jumlah jamaah dengan nomor paspor aktif.
                        </p>
                    </div>
                    ...
                    <table className="w-full text-left text-xs whitespace-nowrap">
                        <thead className="divide-x divide-slate-800 bg-slate-900 text-[10px] font-extrabold tracking-wider text-slate-200 uppercase">
                            <tr>
                                ...
                                <th className="px-4 py-3.5">Akun Rombongan</th>
                                <th className="px-4 py-3.5">Agen Pendaftar</th>
                                <th className="px-4 py-3.5 text-center">
                                    Aksi
                                </th>
                            </tr>
                    ...
                    <div className="flex max-h-[90vh] w-full max-w-lg animate-in flex-col overflow-hidden rounded-3xl bg-white p-0 shadow-2xl duration-200 zoom-in-95">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="col-span-2 space-y-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
...
JamaahDatabase.layout = {
    breadcrumbs: [{ title: 'Database Jamaah', href: '/admin/jamaah-database' }],
};
