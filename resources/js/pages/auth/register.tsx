    ...
    return (
        <div className="min-h-screen bg-white font-sans selection:bg-emerald-200 selection:text-emerald-900">
            ...
            <div className="flex min-h-screen w-full pt-20">
                ...
                {/* Right side - Form */}
                <div className="flex min-h-[calc(100vh-5rem)] w-full items-start justify-center overflow-y-auto bg-gray-50/30 p-6 sm:p-10 lg:w-[55%] xl:p-16">
                            ...
                            {isAgentFlow ? (
                                <div className="animate-in space-y-4 rounded-2xl border border-amber-200 bg-amber-50/50 p-5 duration-300 fade-in slide-in-from-bottom-2">
                                    <div className="flex items-center gap-2 border-b border-amber-200 pb-2 text-sm font-extrabold text-amber-800">
                                        <BookOpen size={18} />
                                        <span>
                                            SOP KEAGENAN ANNAMIRAH TRAVEL
                                        </span>
                                    </div>
                                    <ul className="list-decimal space-y-2 pl-4 text-xs leading-relaxed font-semibold text-amber-900/80">
                                        <li>
                                            Setiap pendaftaran Booking Order
                                            oleh Agen disarankan untuk
                                            mendaftarkan minimal 10 jamaah
                                            (sebagai target kemitraan).
                                        </li>
                                        <li>
                                            Melakukan pendataan jamaah secara
                                            lengkap (KTP, KK, Paspor, Buku Vaksin) 
                                            melalui sistem paling lambatH-45 
                                    ...
                                    <ul className="list-disc space-y-2 pl-4 text-xs leading-relaxed font-semibold text-red-900/80">
                                        ...
                                        <li>
                                            Dilarang menawarkan atau
                                            mempromosikan produk/paket agensi
                                            travel lain kepada jamaah Annamirah
                                            Travel.
                                        </li>
                                        <li>
                                            Dilarang memungut biaya tambahan
                                            liar tanpa persetujuan tertulis dari
                                            Kantor Pusat.
                                        </li>
                                        <li>
                                    ...
                                    <div className="flex items-start gap-2.5 rounded-xl border border-amber-300/60 bg-amber-100/50 p-3">
                                        ...
                                        <p className="text-xs leading-normal font-bold text-amber-800">
                                            Pendaftaran agen memerlukan
                                            verifikasi & persetujuan Admin.
                                            Status akun Anda akan aktif setelah
                                            disetujui.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="animate-in space-y-4 rounded-2xl border border-emerald-200 bg-emerald-50/50 p-5 duration-300 fade-in slide-in-from-bottom-2">
                                    ...
                                    <ul className="list-disc space-y-2.5 pl-4 text-xs leading-relaxed font-semibold text-emerald-900/80">
                                        ...
                                        <li>
                                            ...
                                            Harga paket sewaktu-waktu dapat
                                            berubah menyesuaikan fluktuasi biaya
                                            tiket pesawat dan akomodasi hotel di
                                            Arab Saudi.
                                        </li>
                                        <li>
                                            <strong className="text-emerald-950 underline">
                                            ...
                                            Berkas dokumen asli (Paspor, KTP,
                                            KK, Buku Vaksin Meningitis) wajib
