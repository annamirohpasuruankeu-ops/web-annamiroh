...
/**
* @see \App\Http\Controllers\RoleDashboardController::index
 * @see app/Http/Controllers/RoleDashboardController.php:15
 * @route '/admin'
 */
...
manifests: Object.assign(manifests, manifests),
